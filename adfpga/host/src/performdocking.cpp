...
*/
	...
	// Krnl_LS4
	uint narg_ls4 = 0;
	setKernelArg(kernel_ls4, narg_ls4++, sizeof(ushort), &Host_max_num_of_iters);
#ifdef FIXED_POINT_LS
	setKernelArg(kernel_ls4, narg_ls4++, sizeof(fixedpt), &fixpt_rho_lower_bound);
	setKernelArg(kernel_ls4, narg_ls4++, sizeof(fixedpt), &fixpt_base_dmov_mul_sqrt3);
#else
	setKernelArg(kernel_ls4, narg_ls4++, sizeof(float), &dockpars.rho_lower_bound);
	setKernelArg(kernel_ls4, narg_ls4++, sizeof(float), &dockpars.base_dmov_mul_sqrt3);
#endif
	setKernelArg(kernel_ls4, narg_ls4++, sizeof(uchar), &dockpars.num_of_genes);
#ifdef FIXED_POINT_LS
	setKernelArg(kernel_ls4, narg_ls4++, sizeof(fixedpt), &fixpt_base_dang_mul_sqrt3);
#else
	setKernelArg(kernel_ls4, narg_ls4++, sizeof(float), &dockpars.base_dang_mul_sqrt3);
#endif
	setKernelArg(kernel_ls4, narg_ls4++, sizeof(uchar), &Host_cons_limit);

	// Krnl_LS5
	uint narg_ls5 = 0;
	setKernelArg(kernel_ls5, narg_ls5++, sizeof(ushort),  &Host_max_num_of_iters);
#ifdef FIXED_POINT_LS
	setKernelArg(kernel_ls5, narg_ls5++, sizeof(fixedpt), &fixpt_rho_lower_bound);
	setKernelArg(kernel_ls5, narg_ls5++, sizeof(fixedpt), &fixpt_base_dmov_mul_sqrt3);
#else
	setKernelArg(kernel_ls5, narg_ls5++, sizeof(float), &dockpars.rho_lower_bound);
	setKernelArg(kernel_ls5, narg_ls5++, sizeof(float), &dockpars.base_dmov_mul_sqrt3);
#endif
	setKernelArg(kernel_ls5, narg_ls5++, sizeof(uchar), &dockpars.num_of_genes);
#ifdef FIXED_POINT_LS
	setKernelArg(kernel_ls5, narg_ls5++, sizeof(fixedpt), &fixpt_base_dang_mul_sqrt3);
#else
	setKernelArg(kernel_ls5, narg_ls5++, sizeof(float), &dockpars.base_dang_mul_sqrt3);
#endif
	setKernelArg(kernel_ls5, narg_ls5++, sizeof(uchar), &Host_cons_limit);

	// Krnl_LS6
	uint narg_ls6 = 0;
	setKernelArg(kernel_ls6, narg_ls6++, sizeof(ushort), &Host_max_num_of_iters);
#ifdef FIXED_POINT_LS
	setKernelArg(kernel_ls6, narg_ls6++, sizeof(fixedpt), &fixpt_rho_lower_bound);
	setKernelArg(kernel_ls6, narg_ls6++, sizeof(fixedpt), &fixpt_base_dmov_mul_sqrt3);
#else
	setKernelArg(kernel_ls6, narg_ls6++, sizeof(float), &dockpars.rho_lower_bound);
	setKernelArg(kernel_ls6, narg_ls6++, sizeof(float), &dockpars.base_dmov_mul_sqrt3);
#endif
	setKernelArg(kernel_ls6, narg_ls6++, sizeof(uchar), &dockpars.num_of_genes);
#ifdef FIXED_POINT_LS
	setKernelArg(kernel_ls6, narg_ls6++, sizeof(fixedpt), &fixpt_base_dang_mul_sqrt3);
#else
	setKernelArg(kernel_ls6, narg_ls6++, sizeof(float), &dockpars.base_dang_mul_sqrt3);
#endif
	setKernelArg(kernel_ls6, narg_ls6++, sizeof(uchar), &Host_cons_limit);

	// Krnl_LS7
	uint narg_ls7 = 0;
	setKernelArg(kernel_ls7, narg_ls7++, sizeof(ushort), &Host_max_num_of_iters);
#ifdef FIXED_POINT_LS
	setKernelArg(kernel_ls7, narg_ls7++, sizeof(fixedpt), &fixpt_rho_lower_bound);
	setKernelArg(kernel_ls7, narg_ls7++, sizeof(fixedpt), &fixpt_base_dmov_mul_sqrt3);
#else
	setKernelArg(kernel_ls7, narg_ls7++, sizeof(float), &dockpars.rho_lower_bound);
	setKernelArg(kernel_ls7, narg_ls7++, sizeof(float), &dockpars.base_dmov_mul_sqrt3);
#endif
	setKernelArg(kernel_ls7, narg_ls7++, sizeof(uchar), &dockpars.num_of_genes);
#ifdef FIXED_POINT_LS
	setKernelArg(kernel_ls7, narg_ls7++, sizeof(fixedpt), &fixpt_base_dang_mul_sqrt3);
#else
	setKernelArg(kernel_ls7, narg_ls7++, sizeof(float), &dockpars.base_dang_mul_sqrt3);
#endif
	setKernelArg(kernel_ls7, narg_ls7++, sizeof(uchar), &Host_cons_limit);

	// Krnl_LS8
	uint narg_ls8 = 0;
	setKernelArg(kernel_ls8, narg_ls8++, sizeof(ushort), &Host_max_num_of_iters);
#ifdef FIXED_POINT_LS
	setKernelArg(kernel_ls8, narg_ls8++, sizeof(fixedpt), &fixpt_rho_lower_bound);
	setKernelArg(kernel_ls8, narg_ls8++, sizeof(fixedpt), &fixpt_base_dmov_mul_sqrt3);
#else
	setKernelArg(kernel_ls8, narg_ls8++, sizeof(float), &dockpars.rho_lower_bound);
	setKernelArg(kernel_ls8, narg_ls8++, sizeof(float), &dockpars.base_dmov_mul_sqrt3);
#endif
	setKernelArg(kernel_ls8, narg_ls8++, sizeof(uchar), &dockpars.num_of_genes);
#ifdef FIXED_POINT_LS
	setKernelArg(kernel_ls8, narg_ls8++, sizeof(fixedpt), &fixpt_base_dang_mul_sqrt3);
#else
	setKernelArg(kernel_ls8, narg_ls8++, sizeof(float), &dockpars.base_dang_mul_sqrt3);
#endif
	setKernelArg(kernel_ls8, narg_ls8++, sizeof(uchar), &Host_cons_limit);

	// Krnl_LS9
	uint narg_ls9 = 0;
	setKernelArg(kernel_ls9, narg_ls9++, sizeof(ushort), &Host_max_num_of_iters);
#ifdef FIXED_POINT_LS
	setKernelArg(kernel_ls9, narg_ls9++, sizeof(fixedpt), &fixpt_rho_lower_bound);
	setKernelArg(kernel_ls9, narg_ls9++, sizeof(fixedpt), &fixpt_base_dmov_mul_sqrt3);
#else
	setKernelArg(kernel_ls9, narg_ls9++, sizeof(float), &dockpars.rho_lower_bound);
	setKernelArg(kernel_ls9, narg_ls9++, sizeof(float), &dockpars.base_dmov_mul_sqrt3);
#endif
	setKernelArg(kernel_ls9, narg_ls9++, sizeof(uchar), &dockpars.num_of_genes);
#ifdef FIXED_POINT_LS
	setKernelArg(kernel_ls9, narg_ls9++, sizeof(fixedpt), &fixpt_base_dang_mul_sqrt3);
#else
	setKernelArg(kernel_ls9, narg_ls9++, sizeof(float), &dockpars.base_dang_mul_sqrt3);
#endif
	setKernelArg(kernel_ls9, narg_ls9++, sizeof(uchar), &Host_cons_limit);
